...
type Router struct {
	...
	started           bool
	inboundBindings   map[string]string
...
func NewRouter(ctx context.Context, logFactory log.Factory, options option.RouteOptions, dnsOptions option.DNSOptions) *Router {
	return &Router{
		...
		inboundBindings:   make(map[string]string),
	}
}
...
func (r *Router) BindInboundOutbound(inboundTag, outboundTag string) {
	r.bindingsMu.Lock()
	r.inboundBindings[inboundTag] = outboundTag
	r.bindingsMu.Unlock()
}

func (r *Router) UnbindInbound(inboundTag string) {
	r.bindingsMu.Lock()
	delete(r.inboundBindings, inboundTag)
	r.bindingsMu.Unlock()
}
